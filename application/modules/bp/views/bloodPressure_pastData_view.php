...
<div id="mysugar_sugarNow">
    ...
    <div data-role="navbar">
        <ul>
            ...
            <li><a  data-ajax='false'  href="<?php echo base_url() ?>bp/pastdata" class="ui-btn-active">Past Data</a></li>
    ...
    <div class="dataTable per90 ml20" style="margin-top: 15px">
        <table data-role="table" id="table-custom-2" data-mode="columntoggle" class="ui-body-d ui-shadow table-stripe ui-responsive">
            <thead>
                <tr class="ui-bar-d">
                    <th class='per40'></th>
                    <th class='per15'>Systolic</th>
                    <th class='per15' >Diastolic</th>
                    <th class='per15' ></th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr style="background:#c4f4a6;">
                    ...
                    <td class='per15' >< 140 </td>
                    <td class='per15' >< 80 </td>
                    <td class='per15' ></td>
                </tr>
            </tbody>
        </table>   
                ...
                if (isset($content_data['old_data']['lab_bp']))
                {
                    foreach ($content_data['old_data']['lab_bp'] as $data)
                    {
                        ...
                        <tr>
                            ...
                            <td class='per15' ><?php echo $data['systolic'] ?></td>
                            <td class='per15' ><?php echo $data['diastolic'] ?></td>
                            <td class='per15' ><a data-ajax='false' href="<?php echo base_url() . "bp/edit/" . $data['bp_id'] ?>" ><img style="height:40%; width:40%" src="<?php echo img_url() . 'edit-ico.png' ?>"/></a></td>
                        </tr>
                        <?php
                    }
                }
