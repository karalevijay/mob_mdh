<a href="#" data-rel="back" data-role="button" data-theme="a" data-icon="delete" data-iconpos="notext" class="ui-btn-right">Close</a>
    <form action="<?php echo base_url(); ?>myvisit/add_appointment/1"  method="post" data-ajax="false" onsubmit="return formsubmit_start();"   id="add_app_frm_start" >
                    ...
                    <div class="ui-block-b per35">
                        <div data-role="fieldcontain">
                            <select required="required" name="hour" id="select-native-1" >
                                ...
                                {
                                    ?>
                                    <option <?php if ($i == 8) echo 'selected'; ?> value="<?php if ($i == 0) echo '12';
                                else echo $i; ?>"><?php if ($i == 0) echo '12';
                                else echo $i; ?></option>
    <?php
}
?>
...
?>
                ...
                <div class="ui-grid-a mb10">
                    ...
                    <div class="ui-block-b per70 fRight">
                        <div data-role="fieldcontain">
                            <select name="prescriber" id="add_app_prescriber_start" >
                                <?php
...
?>
                ...
                <div class="ui-grid-a mb10">
                    ...
                    <div class="ui-block-b per70 fRight">
                        <div data-role="fieldcontain">
                            <select required="required" onclick="reasonChange(this.value)" name="reason" id="add_app_reason_start" >
                                <?php
...
?>
                        ...
                        <div class="other" style="display:none;">
                            <input type="text" data-theme='b' id="add_app_other_val_start" name="other" placeholder="Other Reason" />
                        </div>
                    </div>
                </div>
                <div class="ui-grid-a mb10">
