    ...
    <form action="<?php echo base_url(); ?>myvisit/add_appointment/2" onsubmit="return formsubmit();"   method="post" data-ajax="false" id="add_app_frm" >
        <div class="groupDivs border">
            <div class=" m15">
                ...
                <div class="ui-grid-a mb10">
                    ...
                    <input type="hidden" name="go_app_id" value="<?php echo $content_data['app_id']; ?>" />
