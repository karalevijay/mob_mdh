        ...
        <form>
            <div class="groupDivs">
                <div class="mb10 ui-grid-b">
                    ...
                    <div class="ui-block-b per65"><input type="text" placeholder="" value="" data-mini="true"/></div>
                </div>
                <div class="mb10 ui-grid-b">
                    <h4 class="ui-block-a mt15">Speciality</h4>
                    <div class="ui-block-b per65"><select><option>Test</option><option>Test1</option></select></div>
                </div>
                 <div class="mb10 ui-grid-b">
                ...
                <div class="mb10 ui-grid-b">
                    ...
                    <div class="ui-block-b per65"><select><option>California</option><option>San Diago</option></select></div>
                </div>
                <div class="mb10 ui-grid-b">
